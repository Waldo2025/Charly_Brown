...
Cuando el contrato exija los IDs educators, students, parents y coordinators, interprétalos únicamente como cuatro enfoques editoriales técnicos: evidencia y contexto; aplicación práctica; perspectiva humana y cotidiana; estrategia y toma de decisiones. No menciones esas etiquetas ni fuerces un contexto escolar.
...
export const MARCIE_PROMPT_DEFINITIONS = Object.freeze([
  ...
  { id: "approach_proposals", label: "Propuestas de enfoque", group: "Producción", description: "Generación de enfoques para docentes, estudiantes, familias y coordinadores.", defaultPrompt: "Actúa como estratega editorial. Produce cuatro enfoques genuinamente distintos para docentes, estudiantes, familias y coordinadores académicos. Cada propuesta debe adaptar título, promesa, tono, ejemplos y utilidad al público correspondiente, sin limitarse a sustituir palabras ni repetir la misma estructura." },
