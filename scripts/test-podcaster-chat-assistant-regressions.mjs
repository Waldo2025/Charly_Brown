...
// 4. Ensure script tag is present before podcaster.js in podcaster.html
const chatScriptIndex = htmlSource.indexOf('<script data-cache-src="podcaster/podcaster-chat-assistant.js" data-cache-type="module"></script>');
const podcasterScriptIndex = htmlSource.indexOf('<script data-cache-src="podcaster/podcaster.js" data-cache-type="module"></script>');
...
if (chatScriptIndex > podcasterScriptIndex) {
  throw new Error("podcaster-chat-assistant.js debe cargar antes de podcaster.js para exponer window.PodcasterChatAssistant durante init.");
}
