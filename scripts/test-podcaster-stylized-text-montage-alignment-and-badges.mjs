...
const timelineUiJs = readFileSync(new URL("../public/podcaster/podcaster-timeline-ui.js", import.meta.url), "utf8");
...
if (!/podcast-scene-stylized-text-badge/.test(timelineUiJs)
  || !/Contiene texto estilizado/.test(timelineUiJs)) {
